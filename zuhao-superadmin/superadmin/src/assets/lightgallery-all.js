...
(function(root, factory) {
    ...
    (function() {
        ...
        Plugin.prototype.loadContent = function(index, rec, delay) {
            ...
            if (_this.s.dynamic) {
                if (_this.s.dynamicEl[index].poster != undefined && _this.s.dynamicEl[index].poster) {
                    _hasPoster = true;
    ...
    (function() {
        ...
        Video.prototype.init = function() {
            ...
            if (
                ...
                ((_this.core.s.enableSwipe && _this.core.isTouch) || (_this.core.s.enableDrag && !_this.core.isTouch))
            ) {
...
(function(root, factory) {
    ...
    (function() {
        ...
        Zoom.prototype.init = function() {
            ...
            $(".lg-inner").on("mousewheel", function(event, delta) {
                if (delta > 0) {
                    if (_this.core.$outer.find(".lg-current .lg-image").length) {
                        scale += _this.core.s.scale;
                        callScale();
